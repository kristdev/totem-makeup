...
<head>
    ...
    <meta charset="utf-8">
    <title>Totem Make Up</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="">
    <meta name="author" content="">
    <link href='http://fonts.googleapis.com/assets/css?family=Kelly+Slab' rel='stylesheet'
    type='text/<?php echo base_url(); ?>assets/css'>
    <link href="<?php echo base_url(); ?>assets/css/reset.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>assets/css/parallax_style_1.1.3.css" rel="stylesheet" />
    <link href="<?php echo base_url(); ?>assets/css/bootstrap.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>assets/css/style.css" rel="stylesheet" />
    <link href="<?php echo base_url(); ?>assets/css/about_slider/lean-slider.css" rel="stylesheet" />
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/camera.css" />
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/blur.css" />
    <!--blur slidShow -->
    ...
    <![endif]-->
    <!-- Fav and touch icons -->
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php echo base_url(); ?>assets/<?php echo base_url(); ?>assets/<?php echo base_url(); ?>assets/icon/apple-touch-icon-144-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="<?php echo base_url(); ?>assets/icon/apple-touch-icon-114-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php echo base_url(); ?>assets/icon/apple-touch-icon-72-precomposed.png">
    <link rel="apple-touch-icon-precomposed" href="<?php echo base_url(); ?>assets/icon/apple-touch-icon-57-precomposed.png">
    ...
    <div id="navbar" class="navbar navbar-fixed-top">
        <div class="navbar-inner">
            <div class="container">
                ...
                <a class="brand" href="#">Totem<span>Make Up</span>
                </a>
...
<h1>About <span>Totem Makeup</span> </h1>
                        ...
                        <div class="container clearfix">
                            <div class="span12">
                                <div class="span4">
                                    <div class="Team clearfix">
                                        <div class="round-thumb-container">
                                            <div class="round-thumb"> <span><img src="<?php echo base_url(); ?>assets/images/circlegallery/1.jpg"></span>
                                ...
                                <div class="span4">
                                    <div class="Team clearfix">
                                        <div class="round-thumb-container">
                                            <div class="round-thumb"> <span><img src="<?php echo base_url(); ?>assets/images/circlegallery/2.jpg"></span>
                                ...
                                <div class="span4">
                                    <div class="Team clearfix">
                                        <div class="round-thumb-container">
                                            <div class="round-thumb"> <span><img src="<?php echo base_url(); ?>assets/images/circlegallery/3.jpg"></span>
                                    ...
                                    <ul id="stage">
                                        <li data-tags="Photographies">
                                            <div class="filter-thumb-container">
                                                <div class="filter-thumb"> <span><img src="<?php echo base_url(); ?>assets/images/portfolio/1.jpg" alt="Portfolio Filter" /></span>
                                        ...
                                        <li data-tags="Video,Photographies">
                                            <div class="filter-thumb-container">
                                                <div class="filter-thumb"> <span><img src="<?php echo base_url(); ?>assets/images/portfolio/2.jpg" alt="Portfolio Filter" /></span>
                                        ...
                                        <li data-tags="Web Design,Video">
                                            <div class="filter-thumb-container">
                                                <div class="filter-thumb"> <span><img src="<?php echo base_url(); ?>assets/images/portfolio/3.jpg" alt="Portfolio Filter" /></span>
                                        ...
                                        <li data-tags="Web Design,Photographies">
                                            <div class="filter-thumb-container">
                                                <div class="filter-thumb"> <span><img src="<?php echo base_url(); ?>assets/images/portfolio/4.jpg" alt="Portfolio Filter" /></span>
                                        ...
                                        <li data-tags="Video">
                                            <div class="filter-thumb-container">
                                                <div class="filter-thumb"> <span><img src="<?php echo base_url(); ?>assets/images/portfolio/5.jpg" alt="Portfolio Filter" /></span>
                                        ...
                                        <li data-tags="Web Design,Video,Photographies">
                                            <div class="filter-thumb-container">
                                                <div class="filter-thumb"> <span><img src="<?php echo base_url(); ?>assets/images/portfolio/6.jpg" alt="Portfolio Filter" /></span>
                                        ...
                                        <li data-tags="Video,Photographies">
                                            <div class="filter-thumb-container">
                                                <div class="filter-thumb"> <span><img src="<?php echo base_url(); ?>assets/images/portfolio/7.jpg" alt="Portfolio Filter" /></span>
                                        ...
                                        <li data-tags="Web Design">
                                            <div class="filter-thumb-container">
                                                <div class="filter-thumb"> <span><img src="<?php echo base_url(); ?>assets/images/portfolio/8.jpg" alt="Portfolio Filter" /></span>
                                        ...
                                        <li data-tags="Web Design,Video">
                                            <div class="filter-thumb-container">
                                                <div class="filter-thumb"> <span><img src="<?php echo base_url(); ?>assets/images/portfolio/9.jpg" alt="Portfolio Filter" /></span>
                                        ...
                                        <li data-tags="Web Design">
                                            <div class="filter-thumb-container">
                                                <div class="filter-thumb"> <span><img src="<?php echo base_url(); ?>assets/images/portfolio/10.jpg" alt="Portfolio Filter" /></span>
                                        ...
                                        <li data-tags="Video,Photographies">
                                            <div class="filter-thumb-container">
                                                <div class="filter-thumb"> <span><img src="<?php echo base_url(); ?>assets/images/portfolio/11.jpg" alt="Portfolio Filter" /></span>
                                        ...
                                        <li data-tags="Video,Photographies">
                                            <div class="filter-thumb-container">
                                                <div class="filter-thumb"> <span><img src="<?php echo base_url(); ?>assets/images/portfolio/12.jpg" alt="Portfolio Filter" /></span>
                                        ...
                                        <li data-tags="Photographies">
                                            <div class="filter-thumb-container">
                                                <div class="filter-thumb"> <span><img src="<?php echo base_url(); ?>assets/images/portfolio/13.jpg" alt="Portfolio Filter" /></span>
                                        ...
                                        <li data-tags="Web Design,Video">
                                            <div class="filter-thumb-container">
                                                <div class="filter-thumb"> <span><img src="<?php echo base_url(); ?>assets/images/portfolio/14.jpg" alt="Portfolio Filter" /></span>
                                        ...
                                        <li data-tags="Audio">
                                            <div class="filter-thumb-container">
                                                <div class="filter-thumb"> <span><img src="<?php echo base_url(); ?>assets/images/portfolio/18.jpg" alt="Portfolio Filter" /></span>
            ...
            <div id="LargeSlider">
                <div class="container-fluid clearfix LargeSlider">
                    <div class="camera_wrap camera_emboss" id="camera_wrap_3">
                        <div data-src="<?php echo base_url(); ?>assets/images/camera/slides/1.jpg">
                        ...
                        <div data-src="<?php echo base_url(); ?>assets/images/camera/slides/3.jpg" data-time="1500" data-trasPeriod="4000"
                        data-link="#" data-target="_blank">
                            <div class="fadeIn camera_effected Caption">" Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean nibh
                                erat, sagittis sit amet congue at, aliquam eu libero "</div>
                        </div>
                        <div data-src="<?php echo base_url(); ?>assets/images/camera/slides/poster.jpg">
                            <iframe width="100%" height="100%" src="http://www.youtube.com/embed/EokWzMUJcCU?feature=player_detailpage"
                            frameborder="0" allowfullscreen></iframe>
                        </div>
                        <div data-src="<?php echo base_url(); ?>assets/images/camera/slides/4.jpg" data-time="1500" data-trasPeriod="4000"
                        data-link="#" data-target="_blank">
                            <div class="fadeIn camera_effected Caption">" Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean nibh
                                erat, sagittis sit amet congue at, aliquam eu libero "</div>
                        </div>
                        <div data-src="<?php echo base_url(); ?>assets/images/camera/slides/5.jpg" data-time="1500" data-trasPeriod="4000"
                        data-link="#" data-target="_blank">
                            <div class="fadeIn camera_effected Caption">" Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean nibh
                                erat, sagittis sit amet congue at, aliquam eu libero "</div>
                        </div>
                        <div data-src="<?php echo base_url(); ?>assets/images/camera/slides/6.jpg" data-time="1500" data-trasPeriod="4000"
                        data-link="#" data-target="_blank">
                            <div class="fadeIn camera_effected Caption">" Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean nibh
                                erat, sagittis sit amet congue at, aliquam eu libero "</div>
                        </div>
                        <div data-src="<?php echo base_url(); ?>assets/images/camera/slides/7.jpg" data-time="1500" data-trasPeriod="4000"
                        data-link="#" data-target="_blank">
                            <div class="fadeIn camera_effected Caption">" Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean nibh
                                erat, sagittis sit amet congue at, aliquam eu libero "</div>
                        </div>
                        <div data-src="<?php echo base_url(); ?>assets/images/camera/slides/8.jpg" data-time="1500" data-trasPeriod="4000"
                        data-link="#" data-target="_blank">
                            <div class="fadeIn camera_effected Caption">" Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean nibh
                                erat, sagittis sit amet congue at, aliquam eu libero "</div>
                        </div>
                        <div data-src="<?php echo base_url(); ?>assets/images/camera/slides/9.jpg" data-time="1500" data-trasPeriod="4000"
                        data-link="#" data-target="_blank">
                            <div class="fadeIn camera_effected Caption">" Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean nibh
                                erat, sagittis sit amet congue at, aliquam eu libero "</div>
                        </div>
            ...
            <div class="container-fluid Footer">
                <div class="container">
                    <footer>
                        ...
                        <a href="#welcome" class="brand">Totem<span>Make up</span>
                        </a>
                        <p>All rights reserved. Powered by &copy;
                            <a href="http://www.kristdev.com">kristdev</a>
                        </p>
                    </footer>
                </div>
            </div>
...
<!-- Placed at the end of the document so the pages load faster -->
    ...
    <script src="<?php echo base_url(); ?>assets/js/lean-slider.min.js"></script><!-- About Slider-->
    <script src="<?php echo base_url(); ?>assets/js/my_script.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/bootstrap.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/jquery.easing.1.3.min.js"></script><!-- parallax-->
    <script src="<?php echo base_url(); ?>assets/js/modernizr-2.6.1.min.js"></script><!--blur slidShow -->
    <script src="<?php echo base_url(); ?>assets/js/jquery.quicksand.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/jquery.validate.min.js"></script>
    <script src="<?php echo base_url(); ?>assets/js/jquery.mobile.customized.min.js"></script><!-- camera Slider-->
    <script src="<?php echo base_url(); ?>assets/js/camera.min.js"></script><!-- camera Slider-->
    <script src="<?php echo base_url(); ?>assets/js/jquery.parallax-1.1.3.min.js"></script><!--  parallax-->
    <script src="<?php echo base_url(); ?>assets/js/jquery.localscroll-1.2.7-min.js"></script><!--  parallax-->
    <script>
        jQuery(function () {
